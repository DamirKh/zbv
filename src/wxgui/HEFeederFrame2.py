...
from glade_gui.feeder import MyFeederOptionDialog
from feeder_gui import FeederFrame
...
class HEFeederFrame(FeederFrame):
    ...
    def on_btn_fit(self, event):
        with HEMyFeederOptionDialog(parent=self) as FeedConfDialog:
            ...
            if DATA.config.get('CROSS', False): # есть данные для кросс-тренировки
